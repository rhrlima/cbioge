...
from algorithms.rdsge import RandomGrammaticalEvolution
from algorithms import TournamentSelection, DSGECrossover, DSGEMutation, ElitistReplacement
...
def run_evolution():
    ...
    algorithm = RandomGrammaticalEvolution(problem, parser)
