...
problem.DEBUG = False	# prints models running
ge.DEBUG = True			# print evolution info

if problem.DEBUG: print('[DEBUG] problem info will be displayed')
if ge.DEBUG: 	  print('[DEBUG] evolution info will be displayed')
