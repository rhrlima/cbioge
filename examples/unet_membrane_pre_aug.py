...
if __name__ == '__main__':
    ...
    train_gen = DataGenerator(os.path.join(path, 'train_aug'), train_ids, input_shape, batch_size=5, shuffle=False)
    test_gen = DataGenerator(os.path.join(path, 'test_posproc'), test_ids, input_shape, batch_size=5, shuffle=False)
