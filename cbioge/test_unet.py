...
def run_evolution():
    ...
    problem = UNetProblem(
        Grammar('cbioge/assets/grammars/unet_old.json'), 
        Dataset.from_pickle('cbioge/assets/datasets/membrane.pickle', 
            train_size=20), 
        batch_size=5, 
        epochs=1, 
        train_args={
    ...
    GrammaticalEvolution(problem, 
        ...
        crossover=HalfAndHalfOperator(
            ...
            op2=NonterminalMutation(parser=problem.parser, end_index=8), 
            rate=0.6), 
