...
def test_reading_grammar_attributes_name():
    grammar = Grammar('cbioge/assets/grammars/test_grammar.json')
...
def test_dsge_create_solution_with_max_depth():
    np.random.seed(312)
    grammar = Grammar('cbioge/assets/grammars/test_grammar.json', verbose=True)
...
def test_dsge_create_solution_adding_values():
    np.random.seed(0)
    grammar = Grammar('cbioge/assets/grammars/test_grammar.json', True)
